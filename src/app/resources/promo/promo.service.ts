...
export class PromoService {
  ...
  create(params: any): Observable<Promo> {
    return this.http.post(`${environment.api}/promos/create`, params) as Observable<Promo>
  }

  update(params: any): Observable<Promo> {
    return this.http.post(`${environment.api}/promos/${params.id}/update`, params) as Observable<Promo>
  }
